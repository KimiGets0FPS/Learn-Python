...
if sys.platform == "darwin":
    ...
    driver = webdriver.Chrome(options=options,
                              executable_path="../../../../../Downloads/BlooketHack-master/BlooketHack-master/chromedriver.exe")
        ...
        if exists('.styles__nameInput___1z1kJ-camelCase'):
            try:
                driver.execute_script(
                    "document.getElementsByClassName('styles__nameInput___1z1kJ-camelCase')[0].maxLength=9**9;")
                bypassNameLimit = False
            except Exception:
                ...
                if str(question["question"]) == questionShown:
                    if exists('#q1'):
                        ...
                        if str(tmpTag.get_attribute("textContent")) == str(question["correctAnswers"][0]):
                            if autoAnswer == False:
                                driver.execute_script(
                                    'document.getElementById("q1").innerHTML=document.getElementById("q1").innerHTML+"_[Correct]"')
                            else:
                                tmpTag.click()
                    if exists('#q2'):
                        ...
                        if str(tmpTag.get_attribute("textContent")) == str(question["correctAnswers"][0]):
                            if autoAnswer == False:
                                driver.execute_script(
                                    'document.getElementById("q2").innerHTML=document.getElementById("q2").innerHTML+"_[Correct]"')
                            else:
                                tmpTag.click()
                    if exists('#q3'):
                        ...
                        if str(tmpTag.get_attribute("textContent")) == str(question["correctAnswers"][0]):
                            if autoAnswer == False:
                                driver.execute_script(
                                    'document.getElementById("q3").innerHTML=document.getElementById("q3").innerHTML+"_[Correct]"')
                            else:
                                tmpTag.click()
                    if exists('#q4'):
                        ...
                        if str(tmpTag.get_attribute("textContent")) == str(question["correctAnswers"][0]):
                            if autoAnswer == False:
                                driver.execute_script(
                                    'document.getElementById("q4").innerHTML=document.getElementById("q4").innerHTML+"_[Correct]"')
                            else:
                                tmpTag.click()
    except Exception:
