...
def random_list_generators():
    ...
    if user_input == 0:
        ...
        while user_input > 0:
            ...
            user_input -= 1
        print("The output for the 1st my_list is even numbers\nThe output for the 2nd my_list is odd numbers")
        print(f"This is the 1st my_list: {list}\nThis is the 2nd my_list {list_1}")
        print(f"And together, they get the new my_list: {new_list}")
