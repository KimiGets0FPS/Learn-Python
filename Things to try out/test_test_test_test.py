...
def print_banner(bot: TriggerBot) -> None:
    ...
    print("Trigger Durumu       :",
          (Fore.GREEN if bot.toggled else Fore.RED) + ("Açık" if bot.toggled else "Kapalı") + Style.RESET_ALL)
    print("Bunny Durumu         :",
          (Fore.GREEN if bot._bunny else Fore.RED) + ("Açık" if bot._bunny else "Kapalı") + Style.RESET_ALL)
